...
def mostrar_dict(diccionario: dict):
...
def agregar_contacto():
    ...
    if nombre in contactos:
        print("El contacto ya existe, intente con otro.")
    else:
    ...
    if opcion >= 1 and opcion <= 6:
        if opcion == 1:
          ...
          return True
            ...
            print("Su agenda se ha cerrado exitosamente")
        return False
    else:
        print("\nUsted a ingredado una opción incorrecta. \nDebe elegir un valor del 1 al 6 \n")
        return True
